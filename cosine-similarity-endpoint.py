...
# /cosine-similarity?current_question=...&past_question=...
# if you have issues e.g. {"detail":[{"loc":["query","past_question"],"msg":"field required","type":"value_error.missing"}]}'past_question' is not recognized as an internal or external command,operable program or batch file.
# on Windows, then use Git Bash as curl is less buggy/awkward on Git Bash
"""
ignore that last comment, I am not sure why, but 
